(function($) {
	...
	let methods = {
		...
		createElements: function() {
			...
			//dodajemo opciju iz druge biblioteke
			currentGalItems.addClass('lightboxgallery-gallery-item');
			currentGalItems.append('<div class="lightboxgallery-gallery-item-content">'+
				'<span class="lightboxgallery-gallery-item-title">Jesen 2018</span>'
			+'</div>'); 
